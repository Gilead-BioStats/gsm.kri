...
- Metric Metadata: Define key details such as the metric’s description, numerator, denominator, and other relevant specifications. Each KRI must have a unique identifier that follows the existing naming convention (e.g., kri0013 for GSM or kri0002ep for endpoints).
...
By following these steps, we ensure that the new KRI is seamlessly integrated into our analytics framework, maintaining consistency, accuracy, and usability across the system.
