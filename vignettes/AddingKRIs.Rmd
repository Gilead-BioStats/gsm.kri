...
- **Metric Workflow Definition:** Specify the functions and parameters required to calculate the metric. This typically follows the standard `{gsm.core}` [analysis workflow](https://gilead-biostats.github.io/gsm.core/articles/DataAnalysis.html), ensuring consistency with existing metrics.
