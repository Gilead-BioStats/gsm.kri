...
This vignette outlines all of the updates needed in {gsm.mapping} and {gsm.kri} to release a new metric and incorporate it into a report. Throughout this vignette, we will use a PK metric as an example. 
