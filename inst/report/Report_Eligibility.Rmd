...
## Study Overview
```{r, echo=FALSE}
dfResults_Overview <- ResultsProcessor(dfResults = dfResults, dfMetrics = dfMetrics)
QTL_Overview(dfResults = dfResults_Overview,
...
### Site (by %)
```{r, echo = FALSE, results = 'asis', fig.height=4}
if ("bPercentage" %in% names(formals(eligibility_groupBar))) {
