...
### Source
```{r, echo = FALSE, results = 'asis', fig.height=4}
gsm.qtl::eligibility_sourceBar(df = IE_denom)
```

### Criteria/Site
```{r, echo = FALSE, results = 'asis', fig.height=4}
gsm.qtl::criteria_groupBar(df = IE_denom, varGroupID = invid, strGroupLabel = "Site")
```

### Criteria/Country
```{r, echo = FALSE, results = 'asis', fig.height=4}
gsm.qtl::criteria_groupBar(df = IE_denom, varGroupID = country, strGroupLabel = "Country")
```

## Inclusion/Exclusion Listing
```{r, echo = FALSE}
# output the listing on the html
gsm.qtl::eligibility_listing(df = IE_denom)
